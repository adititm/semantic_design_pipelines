...
```bash
python -m semantic_design_pipelines.pipelines.t2ta_sample        --config semantic_design_pipelines/configs/t2ta_sample.yaml
python -m semantic_design_pipelines.pipelines.acr_sample         --config semantic_design_pipelines/configs/acr_sample.yaml
python -m semantic_design_pipelines.pipelines.gene_completion    --config semantic_design_pipelines/configs/gene_completion.yaml
python -m semantic_design_pipelines.pipelines.operon_completion  --config semantic_design_pipelines/configs/operon_completion.yaml
```
...
sbatch --job-name=acr --partition=YOUR_PARTITION \
       ...
       --wrap="semantic_design_pipelines/utils/run_pipeline.sh acr_sample \
               semantic_design_pipelines/configs/acr_sample.yaml"
```
...
Run from the directory *containing* `semantic_design_pipelines/`:
...
```bash
python semantic_design_pipelines/tests/test_parity.py      # 20 checks, expect 0 failures
```
