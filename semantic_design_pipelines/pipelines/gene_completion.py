...
all different (see ``semantic_design_pipelines.stages.identity``):
...
Usage:
    python -m semantic_design_pipelines.pipelines.gene_completion --config configs/gene_completion.yaml
"""
...
from semantic_design_pipelines.core.runner import ProposalRecord, run_prompts
from semantic_design_pipelines.stages.identity import (
